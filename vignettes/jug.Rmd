...
The concept of event listeners have been available since version 0.1.7.902. As middelwares did not suffice to implement a robust logger, the concept of events and event listeners was introduced. Currently _listeners_ can bind to events, an example is given below:
...
In this example, the logger will write to `logfile.log` __and__ will output to the console. 
